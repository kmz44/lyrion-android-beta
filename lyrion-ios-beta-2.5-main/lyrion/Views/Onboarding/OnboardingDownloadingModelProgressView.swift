...
struct OnboardingDownloadingModelProgressView: View {
    ...
    var body: some View {
        VStack {
            ...
            VStack(spacing: 16) {
                // Usa el logo de Lyrion en lugar de la animación de luna
                if installed {
                    Image(.lyrionLogo)
                        .resizable()
                ...
                VStack(spacing: 4) {
                    Text(NSLocalizedString(installed ? "onboarding.downloading.installed" : "onboarding.downloading.installing", comment: ""))
                        .font(.title)
                        .fontWeight(.semibold)
            ...
            if installed {
                ...
                Text(NSLocalizedString("onboarding.downloading.wait", comment: ""))
                    .font(.caption)
        ...
        .padding()
        .navigationTitle(NSLocalizedString("onboarding.downloading.title", comment: ""))
