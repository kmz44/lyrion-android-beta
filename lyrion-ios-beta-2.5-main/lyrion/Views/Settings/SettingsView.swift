            ...
            Form {
                Section {
                    NavigationLink(destination: AppearanceSettingsView()) {
                        Label(NSLocalizedString("settings.appearance", comment: ""), systemImage: "paintpalette")
                    }
                    ...
                    NavigationLink(destination: ChatsSettingsView(currentThread: $currentThread)) {
                        Label(NSLocalizedString("settings.chats", comment: ""), systemImage: "message")
                    }

                    NavigationLink(destination: ModelsSettingsView()) {
                        Label {
                            Text(NSLocalizedString("settings.models", comment: ""))
                                .fixedSize()
                        } icon: {
